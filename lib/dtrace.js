...
var PROBES = {
    // total/idle/pending connections, waiters
    'pool-checkout': [ 'int', 'int', 'int', 'int' ],
    ...
    // reqid, channel
    'listen-start': ['char *', 'char *'],

    // reqid, sql, error message
    'listen-conn-error': ['char *', 'char *', 'char *'],

    // reqid, channel, payload
    'listen-notification': ['char *', 'char *', 'char *'],
