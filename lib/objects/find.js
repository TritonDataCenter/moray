...
function getRecords(req, cb) {
        ...
        var filter = ldap.parseFilter(req.filter);
        var log = req.log;
        var res = req.res;
        ...
        query.on('row', function (row) {
                ...
                obj.value._etag = obj._etag;
                obj.value._mtime = obj._mtime;
                if (filter.matches(obj.value)) {
                        delete obj.value._id;
                        delete obj.value._etag;
                        delete obj.value._mtime;
                        res.write(obj);
                }
        });
