...
function createSQLitePool(opts) {
...
Local.prototype.pg = function pg(options, callback) {
...
Local.prototype.start = function start(opts, cb) {
...
Local.prototype.toString = function toString() {
    var str = '[object Local <';
...
Local.prototype._init = function _init() {
    var self = this;
    var log = this.log;
...
Local.prototype._refresh = function _refresh() {
    var self = this;
